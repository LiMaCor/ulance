...
/**
 * Description of CategoriaMovimientoService
 *
 * @author PixelZer0
 */

class CategoriaMovimientoService implements ServiceTableInterface, ServiceViewInterface {
    ...
    public function get($json) {
        //if ($this->checkPermission("get")) {
            try {
                ...
                $oDao = new CategoriaMovimientoDao();
                $aJson = $oDao->get($json);
